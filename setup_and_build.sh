...
echo "Run this from inside your 'ai-pop' project directory."
...
echo "--- Step 3: Creating GitHub repository 'ai-pop'... ---"
git init
...
gh repo create ai-pop --source=. --public --push
...
jobs:
  build:
    ...
    steps:
      ...
      - name: Build  APK
        run: ./android/gradlew -p ./android assemble
...
echo "--- ✅ All Done! ---"
echo "Your project 'ai-pop' is live on GitHub."
